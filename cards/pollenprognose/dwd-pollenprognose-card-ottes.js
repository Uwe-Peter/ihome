  ...
  _renderMinimalCard(){
    ...
    <ha-card>
      ...
      <div class="flex-container">
        ...
        <div class="sensor">
          <p>${sensor.allergen}</p>
          <img title="${sensor.forecast.attributes.state_today_desc}" src="/hacsfiles/ihome/cards/pollenprognose/images/${sensor.allergen.toLowerCase()}_${!sensor.forecast.state ? 0 : sensor.forecast.state}.svg"/>
          ${this.config.forecast == true
          ? html`<img class="forecast" title="${sensor.forecast.attributes.state_tomorrow_desc}" src="/hacsfiles/ihome/cards/pollenprognose/images/${sensor.allergen.toLowerCase()}_${!sensor.forecast.attributes.state_tomorrow ? 0 : sensor.forecast.attributes.state_tomorrow}.svg"/>`
          : ""}
...
customElements.define('pollenprognose-card-ottes', PollenPrognoseCard);
